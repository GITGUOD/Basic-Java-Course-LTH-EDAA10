...
public class TurtleTest {
	...
	/**
	 * Ritar en kvadrat med två sköldpaddor. Om det inte ritas en kvadrat beror det
	 * troligen på att startpositionen i forward() inte sätts rätt.
	 */
	...
	private void testForwardPenUp() {
		...
		reportResult("Vet sköldpaddan var den är efter att den gått framåt med pennan uppe?",
				(t.getX() == 0 && t.getY() == 145));
	}
